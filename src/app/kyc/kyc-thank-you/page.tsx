        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-lg-8 col-xl-7 text-center">
                    ...
                    <p className="large">Verify your identity to participate in tokensale.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-lg-10 col-xl-9">
                    ...
                    <p className="text-light text-center mgmt-1x">If you have any question, please contact our support team <a href="#">info@tokenwiz.com</a>.</p>
